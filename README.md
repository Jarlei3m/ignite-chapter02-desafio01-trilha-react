...
Caso queira ver o resultado o final (lembrando que esse NÃO é o gabarito oficial da rocketseat, apenas a forma que eu resolvi o desafio, mas ele passou por todos os testes e obteve nota máxima), basta seguir os passos abaixo:

```bash

# Clonar esse repositório
$ git clone https://github.com/Jarlei3m/ignite-chapter02-desafio01-trilha-react

# Entrar na pasta do repositório
$ cd ignite-chapter02-desafio01-trilha-react

# Instalar dependências
$ yarn

# [Opcional] Caso queira verificar o teste
$ yarn test
...
$ yarn start
```
O projeto pode ser visto no seu browser em `http://localhost:3000` e as api's em `http://localhost:3333/stock` e `http://localhost:3333/products`.
